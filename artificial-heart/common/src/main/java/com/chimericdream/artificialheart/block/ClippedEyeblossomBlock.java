...
public class ClippedEyeblossomBlock extends BaseClippedEyeblossomBlock {
    public static final Identifier BLOCK_ID = Identifier.of(ModInfo.MOD_ID, "clipped_eyeblossom");
    ...
    public static final Identifier POTTED_BLOCK_ID = Identifier.of(ModInfo.MOD_ID, "potted_clipped_eyeblossom");
    ...
    public ClippedEyeblossomBlock() {
        super(StatusEffects.NAUSEA, 7.0F, Settings.copy(Blocks.CLOSED_EYEBLOSSOM).registryKey(BLOCK_REGISTRY_KEY));
    }
