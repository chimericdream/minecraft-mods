...
public class ClippedOpenEyeblossomBlock extends BaseClippedEyeblossomBlock {
    public static final Identifier BLOCK_ID = Identifier.fromNamespaceAndPath(ModInfo.MOD_ID, "clipped_open_eyeblossom");
    ...
    public static final Identifier POTTED_BLOCK_ID = Identifier.fromNamespaceAndPath(ModInfo.MOD_ID, "potted_clipped_open_eyeblossom");
