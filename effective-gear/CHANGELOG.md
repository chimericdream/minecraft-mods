...
* Wearing a full set of armor trimmed with the same *pattern* (regardless of material) now grants its
  ...
  pattern's full set at a time:
  * Bolt ⚡ — while sprinting, press the ability key to burst forward, then wait out a short cooldown
    before dashing again
  * Coast — swim and mine underwater as though you have Aqua Affinity; if your helmet already has
  ...
  * Ward — extra partial resistance to a warden's sonic boom, stacking with the echo shard material
    bonus
...
* Fixed the new trim materials not showing up on armor icons in the inventory on Fabric — they still
  showed correctly on the worn armor itself.