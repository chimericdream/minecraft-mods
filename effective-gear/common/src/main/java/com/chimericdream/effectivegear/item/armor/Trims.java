...
public class Trims {
    ...
    public static final TrimMaterialConfig BLAZE_POWDER = new TrimMaterialConfig(
        ModInfo.MOD_ID, "blaze_powder", 0xE6A029, "trims/color_palettes/blaze_powder", "Blaze Powder Material"
    );
    public static final TrimMaterialConfig ECHO_SHARD = new TrimMaterialConfig(
        ModInfo.MOD_ID, "echo_shard", 0x3E5C5C, "trims/color_palettes/echo_shard", "Echo Shard Material"
    );
    public static final TrimMaterialConfig ENCHANTED_GOLDEN_APPLE = new TrimMaterialConfig(
        ModInfo.MOD_ID, "enchanted_golden_apple", 0xF6C13D, "trims/color_palettes/enchanted_golden_apple", "Enchanted Golden Apple Material"
    );
    public static final TrimMaterialConfig HONEYCOMB = new TrimMaterialConfig(
        ModInfo.MOD_ID, "honeycomb", 0xD9A22C, "trims/color_palettes/honeycomb", "Honeycomb Material"
    );
    public static final TrimMaterialConfig NETHER_STAR = new TrimMaterialConfig(
        ModInfo.MOD_ID, "nether_star", 0xFDF4B8, "trims/color_palettes/nether_star", "Nether Star Material"
    );
    public static final TrimMaterialConfig SLIMEBALL = new TrimMaterialConfig(
        ModInfo.MOD_ID, "slimeball", 0x7CC93E, "trims/color_palettes/slimeball", "Slimeball Material"
    );
    public static final TrimMaterialConfig TURTLE_SCUTE = new TrimMaterialConfig(
        ModInfo.MOD_ID, "turtle_scute", 0x6B8E4E, "trims/color_palettes/turtle_scute", "Turtle Scute Material"
    );
