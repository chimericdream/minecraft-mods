...
/** Tints the placed dyed pumpkin block from the color stored on its {@link DyedPumpkinBlockEntity}. */
public final class DyedPumpkinBlockColors {
    public static final BlockTintSource TINT_SOURCE = new BlockTintSource() {
        ...
        public int colorInWorld(BlockState state, BlockAndTintGetter level, BlockPos pos) {
            if (level != null && pos != null) {
                ...
                if (blockEntity instanceof DyedPumpkinBlockEntity dyedPumpkin) {
                    return ARGB.opaque(dyedPumpkin.getColor());
                }
            }
    ...
    private DyedPumpkinBlockColors() {
    }
}
