        ...
        return YetAnotherConfigLib.create(HANDLER, ((defaults, config, builder) -> builder
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.<Double>createBuilder()
                    .name(Component.literal("First edition chance"))
                    .description(OptionDescription.of(Component.literal("The chance of getting a first-edition book. Default: 0.05 (5%)")))
                    ...
                    .build())
                .option(Option.<Double>createBuilder()
                    .name(Component.literal("Second edition chance"))
                    .description(OptionDescription.of(Component.literal("The chance of getting a second-edition book. Default: 0.2 (20%)")))
                    ...
                    .build())
                .option(Option.<Double>createBuilder()
                    .name(Component.literal("Third edition chance"))
                    .description(OptionDescription.of(Component.literal("The chance of getting a third-edition book. Default: 0.5 (50%)")))
