 ...
 * {@link ZombieFishConverter}. Shares its look and sounds with a regular tropical fish; only its
 * behavior (hostile, 1 heart of health, immune to drowning/sunlight) is different. See
 * {@link ZombieFishBehavior} for the AI shared with {@link ZombieSalmon} and {@link ZombieCod}.
 */
public class ZombieTropicalFish extends TropicalFish {
    private int attackCooldown = 0;

    public ZombieTropicalFish(EntityType<? extends ZombieTropicalFish> type, Level level) {
        super(type, level);
    }
