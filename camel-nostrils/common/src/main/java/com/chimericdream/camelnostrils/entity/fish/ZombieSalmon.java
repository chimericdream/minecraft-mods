 ...
 * Shares its look and sounds with a regular salmon; only its behavior (hostile, 1 heart of health,
 * immune to drowning/sunlight) is different. See {@link ZombieFishBehavior} for the AI shared with
 * {@link ZombieCod} and {@link ZombieTropicalFish}.
 */
public class ZombieSalmon extends Salmon {
    private int attackCooldown = 0;

    public ZombieSalmon(EntityType<? extends ZombieSalmon> type, Level level) {
        super(type, level);
    }
