...
> **Provenance:** derived from the MC 26.2 merged-deobf jar. The mechanism described here is
> believed to be the same on 26.1.2, but this branch targets 26.1.2 — re-verify against the
> 26.1.2 jar before relying on exact method bodies, signatures or line references.
