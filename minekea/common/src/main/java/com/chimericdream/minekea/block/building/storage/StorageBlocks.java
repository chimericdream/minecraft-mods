...
public class StorageBlocks implements ModThingGroup {
    ...
    static {
        ...
        CARROT_BLOCK = REGISTRY_HELPER.registerWithItem(ItemStorageBlock.makeId("carrot"), () -> new ItemStorageBlock(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.HAY_BLOCK).sounds(BlockSoundGroup.CROP)).item(Items.CARROT).material("carrot").materialName("Carrot").tool(Tool.HOE), true), DEFAULT_STORAGE_BLOCK_SETTINGS);
        CHARCOAL_BLOCK = REGISTRY_HELPER.registerWithItem(ItemStorageBlock.makeId("charcoal"), () -> new ItemStorageBlock(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.COAL_BLOCK).sounds(BlockSoundGroup.TUFF)).item(Items.CHARCOAL).material("charcoal").name("Charcoal Block").tool(Tool.PICKAXE)), DEFAULT_STORAGE_BLOCK_SETTINGS);
        ...
        FLINT_BLOCK = REGISTRY_HELPER.registerWithItem(ItemStorageBlock.makeId("flint"), () -> new ItemStorageBlock(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.COBBLESTONE).sounds(BlockSoundGroup.STONE)).material("flint").item(Items.FLINT).materialName("Flint").tool(Tool.PICKAXE)), DEFAULT_STORAGE_BLOCK_SETTINGS);
        ...
        LEATHER_BLOCK = REGISTRY_HELPER.registerWithItem(ItemStorageBlock.makeId("leather"), () -> new ItemStorageBlock(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)).item(Items.LEATHER).material("leather").materialName("Leather").tool(Tool.SHEARS)), DEFAULT_STORAGE_BLOCK_SETTINGS);
        ...
        POTATO_BLOCK = REGISTRY_HELPER.registerWithItem(ItemStorageBlock.makeId("potato"), () -> new ItemStorageBlock(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.HAY_BLOCK).sounds(BlockSoundGroup.CROP)).item(Items.POTATO).material("potato").materialName("Potato").tool(Tool.HOE), true), DEFAULT_STORAGE_BLOCK_SETTINGS);
        ...
        STICK_BLOCK = REGISTRY_HELPER.registerWithItem(ItemStorageBlock.makeId("stick"), () -> new ItemStorageBlock(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).sounds(BlockSoundGroup.WOOD)).item(Items.STICK).material("stick").materialName("Stick").tool(Tool.AXE)), DEFAULT_STORAGE_BLOCK_SETTINGS);
        SUGAR_BLOCK = REGISTRY_HELPER.registerWithItem(ItemStorageBlock.makeId("sugar"), () -> new ItemStorageBlock(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.HAY_BLOCK).sounds(BlockSoundGroup.SAND)).item(Items.SUGAR).material("sugar").materialName("Sugar").tool(Tool.SHOVEL), true), DEFAULT_STORAGE_BLOCK_SETTINGS);
