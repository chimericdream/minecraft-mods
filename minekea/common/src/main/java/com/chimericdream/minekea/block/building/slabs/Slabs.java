...
public class Slabs implements ModThingGroup {
    ...
    static {
        SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(SlabBlock.makeId("basalt_bricks"), () -> new SlabBlock(new BlockConfig().material("basalt_bricks").materialName("Basalt Brick").ingredient(BuildingBlocks.BASALT_BRICKS.get()).texture(TextureUtils.block(BasaltBricksBlock.BLOCK_ID))), DEFAULT_SLAB_SETTINGS));
        SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(SlabBlock.makeId("cracked_basalt_bricks"), () -> new SlabBlock(new BlockConfig().material("cracked_basalt_bricks").materialName("Cracked Basalt Brick").ingredient(BuildingBlocks.CRACKED_BASALT_BRICKS.get()).texture(TextureUtils.block(CrackedBasaltBricksBlock.BLOCK_ID))), DEFAULT_SLAB_SETTINGS));
        SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(SlabBlock.makeId("crimson_basalt_bricks"), () -> new SlabBlock(new BlockConfig().material("crimson_basalt_bricks").materialName("Crimson Basalt Brick").ingredient(BuildingBlocks.CRIMSON_BASALT_BRICKS.get()).texture(TextureUtils.block(CrimsonBasaltBricksBlock.BLOCK_ID))), DEFAULT_SLAB_SETTINGS));
        SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(SlabBlock.makeId("mossy_basalt_bricks"), () -> new SlabBlock(new BlockConfig().material("mossy_basalt_bricks").materialName("Mossy Basalt Brick").ingredient(BuildingBlocks.MOSSY_BASALT_BRICKS.get()).texture(TextureUtils.block(MossyBasaltBricksBlock.BLOCK_ID))), DEFAULT_SLAB_SETTINGS));
        SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(SlabBlock.makeId("warped_basalt_bricks"), () -> new SlabBlock(new BlockConfig().material("warped_basalt_bricks").materialName("Warped Basalt Brick").ingredient(BuildingBlocks.WARPED_BASALT_BRICKS.get()).texture(TextureUtils.block(WarpedBasaltBricksBlock.BLOCK_ID))), DEFAULT_SLAB_SETTINGS));
        SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(SlabBlock.makeId("warped_nether_bricks"), () -> new SlabBlock(new BlockConfig().material("warped_nether_bricks").materialName("Warped Nether Brick").ingredient(BuildingBlocks.WARPED_NETHER_BRICKS.get()).texture(TextureUtils.block(WarpedNetherBricksBlock.BLOCK_ID))), DEFAULT_SLAB_SETTINGS));
        ...
        VERTICAL_SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(VerticalSlabBlock.makeId("cut_copper"), () -> new VerticalSlabBlock(new BlockConfig().material("cut_copper").materialName("Cut Copper").ingredient(Blocks.CUT_COPPER)), DEFAULT_VERTICAL_SLAB_SETTINGS));
        VERTICAL_SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(VerticalSlabBlock.makeId("waxed_cut_copper"), () -> new VerticalSlabBlock(new BlockConfig().material("waxed_cut_copper").materialName("Waxed Cut Copper").ingredient(Blocks.WAXED_CUT_COPPER).texture(TextureUtils.block(Blocks.CUT_COPPER))), DEFAULT_VERTICAL_SLAB_SETTINGS));
        VERTICAL_SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(VerticalSlabBlock.makeId("exposed_cut_copper"), () -> new VerticalSlabBlock(new BlockConfig().material("exposed_cut_copper").materialName("Exposed Cut Copper").ingredient(Blocks.EXPOSED_CUT_COPPER)), DEFAULT_VERTICAL_SLAB_SETTINGS));
        ...
        VERTICAL_SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(VerticalSlabBlock.makeId("weathered_cut_copper"), () -> new VerticalSlabBlock(new BlockConfig().material("weathered_cut_copper").materialName("Weathered Cut Copper").ingredient(Blocks.WEATHERED_CUT_COPPER)), DEFAULT_VERTICAL_SLAB_SETTINGS));
        ...
        VERTICAL_SLAB_BLOCKS.add(REGISTRY_HELPER.registerWithItem(VerticalSlabBlock.makeId("oxidized_cut_copper"), () -> new VerticalSlabBlock(new BlockConfig().material("oxidized_cut_copper").materialName("Oxidized Cut Copper").ingredient(Blocks.OXIDIZED_CUT_COPPER)), DEFAULT_VERTICAL_SLAB_SETTINGS));
