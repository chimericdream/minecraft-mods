...
public class CrimsonBasaltBricksDataGenerator implements ChimericLibBlockDataGenerator {
    ...
    public void configureRecipes(RegistryWrapper.WrapperLookup registryLookup, RecipeExporter exporter, RecipeGenerator generator) {
        generator.createShapeless(RecipeCategory.BUILDING_BLOCKS, BLOCK, 1)
            ...
            .criterion(RecipeGenerator.hasItem(Blocks.WEEPING_VINES),
                generator.conditionsFromItem(Blocks.WEEPING_VINES))
            .offerTo(exporter);
