...
> **Backport note.** This plan was authored on the MC 26.2 line and backported to `26.1.2` verbatim so
> the per-item reasoning stays intact. Where it names a version it means the 26.2 line: this branch is
> Minecraft **26.1.2**, chimeric-lib **5.x**, Architectury **20.0.7**. The findings and resolutions
> themselves are version-independent — Phase 1 and Phase 2 are backported here as their own commits.
