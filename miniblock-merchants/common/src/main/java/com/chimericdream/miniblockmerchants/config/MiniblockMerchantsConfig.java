        ...
        return YetAnotherConfigLib.create(HANDLER, ((defaults, config, builder) -> builder
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.ancientShellChance"))
                ...
                .option(Option.<Integer>createBuilder()
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.enchantedRedDeliciousChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.endlessBookshelfChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    .binding(Defaults.ENDLESS_BOOKSHELF_CHANCE, () -> config.endlessBookshelfChance, newVal -> config.endlessBookshelfChance = newVal)
                    .controller(opt -> IntegerFieldControllerBuilder.create(opt).min(1))
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.fineThreadChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    .binding(Defaults.FINE_THREAD_CHANCE, () -> config.fineThreadChance, newVal -> config.fineThreadChance = newVal)
                    .controller(opt -> IntegerFieldControllerBuilder.create(opt).min(1))
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.forgottenScrapMetalChance"))
                    .description(OptionDescription.of(Component.literal("")))
                ...
                .option(Option.<Integer>createBuilder()
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.pureGoldChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    .binding(Defaults.PURE_GOLD_CHANCE, () -> config.pureGoldChance, newVal -> config.pureGoldChance = newVal)
                    .controller(opt -> IntegerFieldControllerBuilder.create(opt).min(1))
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.radiatingRedstoneChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    .binding(Defaults.RADIATING_REDSTONE_CHANCE, () -> config.radiatingRedstoneChance, newVal -> config.radiatingRedstoneChance = newVal)
                    .controller(opt -> IntegerFieldControllerBuilder.create(opt).min(1))
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.rottingRecyclingBinChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.sculptingClayChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    .binding(Defaults.SCULPTING_CLAY_CHANCE, () -> config.sculptingClayChance, newVal -> config.sculptingClayChance = newVal)
                    .controller(opt -> IntegerFieldControllerBuilder.create(opt).min(1))
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.shimmeringWheatChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    .binding(Defaults.SHIMMERING_WHEAT_CHANCE, () -> config.shimmeringWheatChance, newVal -> config.shimmeringWheatChance = newVal)
                    .controller(opt -> IntegerFieldControllerBuilder.create(opt).min(1))
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.soakedVillagerPlushieChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.sparklingBlazePowderChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.stabilizedExplosionChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.unusuallyDenseRockChance"))
                    .description(OptionDescription.of(Component.literal("")))
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.miniblockmerchants.option.wagyuBeefChance"))
                    .description(OptionDescription.of(Component.literal("")))
