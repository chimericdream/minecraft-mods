...
public class ArmorTrimAtlasProvider implements DataProvider {
    ...
    /** Mirrors {@code assets/minecraft/atlases/armor_trims.json}'s vanilla pattern list, MC 26.1.2. */
    ...
    /** Mirrors {@code assets/minecraft/atlases/items.json}'s vanilla texture list, MC 26.1.2. */
