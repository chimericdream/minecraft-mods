...
public class TagUtils {
     ...
     */
    public static void applyMineableTag(Function<TagKey<Block>, TagAppender<Block, Block>> getBuilder, @Nullable Tool tool, Block block) {
    ...
    public static void applyMineableTag(Function<TagKey<Block>, TagAppender<Block, Block>> getBuilder, @Nullable Tool tool, Tool defaultTool, Block block) {
