 ...
 * <b>render time</b> off the live stack, not at bake time off the item's default components: Minecraft
 ...
 * {@code docs/TESTING.md}), so {@link TrimmedArmorModelLoadingPlugin} wraps every item
