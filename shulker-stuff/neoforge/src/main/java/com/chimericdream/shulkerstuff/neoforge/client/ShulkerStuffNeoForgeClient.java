...
import com.chimericdream.shulkerstuff.neoforge.client.render.item.ShulkerBoxSpecialModel;
...
public class ShulkerStuffNeoForgeClient {
    ...
    public static void registerSpecialModelRenderer(RegisterSpecialModelRendererEvent event) {
        event.register(ShulkerBoxSpecialModel.TYPE_ID, ShulkerBoxSpecialModel.UNBAKED.type());
    }
}
