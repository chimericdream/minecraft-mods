package com.chimericdream.archaeologytweaks.registry;
...
public class ModRegistries {
    ...
    public static void init() {
        ArchaeologyTweaksMod.LOGGER.debug("Registering fluids");
        FLUIDS.register();

        ArchaeologyTweaksMod.LOGGER.debug("Registering blocks");
        BLOCKS.register();

        ArchaeologyTweaksMod.LOGGER.debug("Registering block entities");
        BLOCK_ENTITY_TYPES.register();

        ArchaeologyTweaksMod.LOGGER.debug("Registering items");
        ITEMS.register();

        ArchaeologyTweaksMod.LOGGER.debug("Registering item groups");
        ITEM_GROUPS.register();

        ArchaeologyTweaksMod.LOGGER.debug("Registering entities");
        ENTITY_TYPES.register();

        ArchaeologyTweaksMod.LOGGER.debug("Registering screen handlers");
