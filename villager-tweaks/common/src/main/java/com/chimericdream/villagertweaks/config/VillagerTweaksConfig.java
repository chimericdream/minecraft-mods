        ...
        return YetAnotherConfigLib.create(HANDLER, ((defaults, config, builder) -> builder
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.<Boolean>createBuilder()
                    .name(Component.translatable("text.config.option.enableMaxTradeOverride"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.enableMaxTradeOverride.desc")))
                ...
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.option.maxTradesOverrideAmount"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.maxTradesOverrideAmount.desc")))
                    ...
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Component.translatable("text.config.option.enableDemandBonus"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.enableDemandBonus.desc")))
                    .binding(Defaults.ENABLE_DEMAND_BONUS, () -> config.enableDemandBonus, newVal -> config.enableDemandBonus = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Component.translatable("text.config.option.enableGlobalReputation"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.enableGlobalReputation.desc")))
                    .binding(Defaults.ENABLE_GLOBAL_REPUTATION, () -> config.enableGlobalReputation, newVal -> config.enableGlobalReputation = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Component.translatable("text.config.option.enableBadReputation"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.enableBadReputation.desc")))
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.<Boolean>createBuilder()
                    .name(Component.translatable("text.config.option.forceVillagerConversion"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.forceVillagerConversion.desc")))
                    .binding(Defaults.FORCE_VILLAGER_CONVERSION, () -> config.forceVillagerConversion, newVal -> config.forceVillagerConversion = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Component.translatable("text.config.option.enableConversionTimeOverride"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.enableConversionTimeOverride.desc")))
                    ...
                    .build())
                .option(Option.<Integer>createBuilder()
                    .name(Component.translatable("text.config.option.conversionTime"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.conversionTime.desc")))
                    .binding(Defaults.CONVERSION_TIME, () -> config.conversionTime, newVal -> config.conversionTime = newVal)
                    .controller(IntegerFieldControllerBuilder::create)
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Component.translatable("text.config.option.displayConversionTime"))
                    .description(OptionDescription.of(Component.translatable("text.config.option.displayConversionTime.desc")))
