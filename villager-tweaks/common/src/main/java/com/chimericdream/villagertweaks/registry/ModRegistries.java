package com.chimericdream.villagertweaks.registry;
...
public class ModRegistries {
    ...
    public static void init() {
        ...
        VillagerTweaksMod.LOGGER.debug("[houdiniblock] registering blocks");
        BLOCKS.register();

        VillagerTweaksMod.LOGGER.debug("[houdiniblock] registering items");
        ITEMS.register();
    }
