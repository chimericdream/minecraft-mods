...
public class XtremeHopperRecipeGenerator extends RecipeProvider {
    ...
    private void generateGlazedHopperRecipes() {
        ...
        makeShapelessUpgradeRecipe(ModBlocks.NETHER_STAR_HOPPER.get().asItem(), Items.GRAY_GLAZED_TERRACOTTA, 1, ModBlocks.GLAZED_NETHER_STAR_HOPPER.get().asItem(), "glazed_hoppers", "_from_nether_star");
